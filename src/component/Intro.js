        ...
        <div className='aboutMe'>
            ...
            <div className='aboutMeRight'>
                ...
                <div>
                    ...
                    <div className='introContent'>
                       <p>
                           <strong>첫번째, 사색</strong> - 개발은 흰색 도화지에 그림을 그리는 것과 같다고 생각합니다. 프로그래밍이 흥미로웠던 이유는 정답이 없기 때문입니다. 정해진 답과 반복되는 업무가 아니라 프로세스와 기능에 대해 스스로 고찰하고 다양한 방법으로 개발을 할 수 있다는 점이 매우 매력적으로 느껴졌습니다. 저는 끊임없이 사색하는 걸 좋아합니다. 더 간단하고 좋은 소스가 무엇일까 사색을 하다 보면 다양한 아이디어가 떠오르고 색다른 방법도 떠올릴 수 있었습니다. 간단한 코드를 작성하더라도 다른 사람이 봤을 때 쉽게 이해할 수 있도록 최대한 깔끔하게 작성하려 했습니다. 또한, 여러 곳에서 사용하는 이미지 슬라이드 기능을 공통함수로 만들어 팀원들이 편리하게 사용할 수 있도록 하였습니다. 창의력을 발휘한 협업을 하는 개발자가 되겠습니다.
                       </p>
                        <p>
                            <strong>두번째, 소통과 신뢰</strong> - 관계에서 가장 중요하다고 여기는 가치는 ‘소통’과 ‘신뢰’라고 생각합니다. 맡은 업무를 묵묵히 잘 해내면서 업무 관계에서 신뢰를 쌓아왔습니다. 선임들은 이런 모습을 보고 업무 스타일이 든든하고 책임감 있다며 칭찬해 주셨습니다. 맡은 업무를 이해하기 위해 꼼꼼하게 정리하고 문제점을 발견하면 선임, 동료들과 소통을 통해 즉각적으로 해결하려 합니다. 또한, 경청을 잘하는 사람입니다. 업무를 해결하는데 있어 자신의 생각과 방식만을 고집하기보다 같이 고민하고 상대방의 의견을 수용하며 신뢰를 쌓아왔습니다. 맡은 일에 최선을 다해 믿음직한 모습을 보여드리겠습니다.
                       </p>
                        <p>
                            <strong>셋째, 숲을 보는 개발자</strong> - 개발은 코딩업무만큼 프로세스에 대해 정확히 이해를 하는 것이 중요하다고 생각합니다. 경영학을 전공하면서 효율적인 의사결정을 하는 방법과 전략적인 경영 프로세스에 대해 학습했습니다. 그로 인해 업무와 프로세스에 대한 이해가 남들보다 빨라질 수 있었고 팀원들에게 프로세스를 이해시키는 데 도움을 주었습니다. 경영 업무 프로세스와 프로그래밍을 동시에 이해할 수 있어 업무를 진행하는데 좀 더 넓고 다양한 관점에서 바라볼 수 있습니다. 이런 장점을 살려 회사 업무에 대해서도 넓은 시각으로 바라볼 수 있는 사람이 되겠습니다.
                       </p>
                    </div>
                </div>
                <div>
